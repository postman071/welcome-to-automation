...
/**
 * 2.1 Create the class with the name "Variable Q2"
 ...
 * 2.4 Create a method with no return type and no parameter with the name "display"
 * and write a SOUT statement to print the value of the above variables.
 ...
 * 102 - Prime
 */
public class Variable_Q2              // Create the class name
{
    ...
    {
        this.id=id;         //Parameterised Constructor
        this.name=name;
    }
    public void display()
    {
    ...
    {
        Variable_Q2 obj1=new Variable_Q2(101,"Janak");
        obj1.display();
